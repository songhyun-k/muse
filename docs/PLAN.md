...
- [x] C01 — Public source import, original demo media, MIT, English UI and verified packages.
- [ ] C02 — Settings modal: reuse UI preferences, verify keyboard/mouse and build; no commit.
